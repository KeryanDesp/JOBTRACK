...
import { languageSchema, reorderSchema, type LanguageInput, type ReorderInput, type SessionUser } from '@jobtrack/shared';
...
export class LanguagesController {
  ...
  private readonly config: CollectionConfig = { name: 'language', dateFields: [] } as const;
  ...
  @Post()
  create(
    @Body(new ZodValidationPipe(languageSchema)) body: LanguageInput,
