...
import { educationSchema, reorderSchema, type EducationInput, type ReorderInput, type SessionUser } from '@jobtrack/shared';
...
export class EducationsController {
  ...
  private readonly config: CollectionConfig = { name: 'education', dateFields: ['startDate', 'endDate'] } as const;
  ...
  @Post()
  create(
    @Body(new ZodValidationPipe(educationSchema)) body: EducationInput,
