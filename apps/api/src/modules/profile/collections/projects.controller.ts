...
import { projectSchema, reorderSchema, type ProjectInput, type ReorderInput, type SessionUser } from '@jobtrack/shared';
import { CurrentUser } from '../../../common/decorators/current-user.decorator';
import { ZodValidationPipe } from '../../../common/zod-validation.pipe';
import { ProfileCollectionService, type CollectionConfig, type CollectionRow } from '../collection.service';

@Controller('profile/projects')
export class ProjectsController {
  constructor(private readonly collections: ProfileCollectionService) {}

  private readonly config: CollectionConfig = { name: 'project', dateFields: [] } as const;
  ...
  @Post()
  create(
    @Body(new ZodValidationPipe(projectSchema)) body: ProjectInput,
